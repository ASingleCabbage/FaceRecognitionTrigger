...
minDifference = 0.1	#switched to negative temporarily to disable the function
...
while True:
	...
	for encoding in encodings:
		matches = face_recognition.compare_faces(knownEncodings, encoding, tolerance=0.45)
		name = "unknown"
